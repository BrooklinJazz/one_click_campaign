defmodule OneClickCampaignWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OneClickCampaignWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OneClickCampaignWeb.Gettext, "errors", msg, opts)
    end
  end
